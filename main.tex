...
a model outperforms persistence, but also up to which horizon that
advantage remains operationally useful across consecutive days.
...
Valencia stations were generally more predictable than Madrid
stations across pollutants and models, consistent with the more stable
meteorological regime of a coastal Mediterranean setting.
